      ...
      <div class="container-fluid">
		...
		<div class="card card-default">
          <div class="card-header">
            <h3 class="card-title">Filter Data Tgl Masuk Benang Sample</h3>
...
$total_qty = null;		
  ...
  $sqlDB21 = " SELECT  a1.VALUESTRING AS KETS, a2.VALUESTRING AS SJ, SUM(x.BASESECONDARYQUANTITY) AS QTY_CONES, SUM(x.BASEPRIMARYQUANTITY) AS QTY_KG,
COUNT(x.ITEMELEMENTCODE) AS QTY_DUS, x.LOTCODE,x.WHSLOCATIONWAREHOUSEZONECODE, x.WAREHOUSELOCATIONCODE, x.TRANSACTIONDATE,
x.ITEMTYPECODE, x.DECOSUBCODE01, x.DECOSUBCODE02, x.DECOSUBCODE03, x.DECOSUBCODE04,
...
WHERE x.ITEMTYPECODE = 'GYR' AND x.TEMPLATECODE = 'OPN' AND a1.VALUESTRING = '1' AND x.TRANSACTIONDATE BETWEEN '$Awal' AND '$Akhir'
GROUP BY a1.VALUESTRING, a2.VALUESTRING,  x.TRANSACTIONDATE,
x.WHSLOCATIONWAREHOUSEZONECODE, x.WAREHOUSELOCATIONCODE, x.LOTCODE,x.ITEMTYPECODE, x.DECOSUBCODE01, x.DECOSUBCODE02, x.DECOSUBCODE03, x.DECOSUBCODE04,
x.DECOSUBCODE05, x.DECOSUBCODE06, x.DECOSUBCODE07, x.DECOSUBCODE08 ";
  ...
  $cd = trim($rowdb21['DECOSUBCODE01'])."-".trim($rowdb21['DECOSUBCODE02'])."-"
    ...
    ?>
      ...
      <td style="text-align: center"><?php echo "SAMPLE" ?></td>
