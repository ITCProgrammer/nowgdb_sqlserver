...
<!-- Main content -->
      <div class="container-fluid">
		...
		<div class="card card-success">
          <div class="card-header">
            <h3 class="card-title">Filter Data Tgl Masuk Benang Retur (RMP)</h3>
	...
	<div class="card card-danger">
      <div class="card-header">
        <h3 class="card-title">Detail Data Benang Retur dari Supplier (RMP) GYR</h3>
		<div class="btn-group float-right">
		<a href="pages/cetak/laprrmpmasuk_excel.php?awal=<?php echo $Awal;?>&akhir=<?php echo $Akhir;?>" class="btn bg-blue" target="_blank">Cetak Excel</a>
		<a href="pages/cetak/cetaklaprmpmasukretur.php?tgl1=<?php echo $Awal; ?>&tgl2=<?php echo $Akhir; ?>" class="btn bg-green" target="_blank">Cetak</a>
		</div>   
      </div>
      <!-- /.card-header -->
      <div class="card-body">
...
$total_qty = null;		
  ...
  $sqlDB21 = " SELECT  x.TRANSACTIONNUMBER, a1.VALUESTRING AS KETS, a2.VALUESTRING AS SJ, a3.VALUESTRING AS KETSDYR, a4.VALUESTRING AS SJDYR, e.LEGALNAME1, SUM(x.BASESECONDARYQUANTITY) AS QTY_CONES, 
...
GROUP BY x.TRANSACTIONNUMBER, a1.VALUESTRING, a2.VALUESTRING, a3.VALUESTRING, a4.VALUESTRING,  x.TRANSACTIONDATE, e.LEGALNAME1,
...
ORDER BY a1.VALUESTRING ASC LIMIT 1 ";
  ...
  $r1=db2_fetch_assoc($stmt11);
    ?>
      ...
      <td><?php if($rowdb21['ITEMTYPECODE']=="GYR"){ echo $rowdb21['SJ']; }else if($rowdb21['ITEMTYPECODE']=="DYR"){ echo $rowdb21['SJDYR']; } ?></td>
      <td><?php echo $cd; ?></td> 
   ...
   <tfoot>
	...
	<div class="card card-warning">
      <div class="card-header">
        <h3 class="card-title">Detail Data Benang Retur dari Supplier (RMP) DYR</h3>
		<div class="btn-group float-right">
		<a href="pages/cetak/laprrmpmasukdyr_excel.php?awal=<?php echo $Awal;?>&akhir=<?php echo $Akhir;?>" class="btn bg-blue" target="_blank">Cetak Excel</a>
		<a href="pages/cetak/cetaklaprmpmasukdyrretur.php?tgl1=<?php echo $Awal; ?>&tgl2=<?php echo $Akhir; ?>" class="btn bg-green" target="_blank">Cetak</a>
		</div>   
      </div>
      <!-- /.card-header -->
      <div class="card-body">
...
LEFT OUTER JOIN CUSTOMERSUPPLIERDATA d ON c.SUPPLIERCODE =d.CODE AND d.COMPANYCODE = '100' AND d.TYPE = '2'
LEFT OUTER JOIN BUSINESSPARTNER e ON d.BUSINESSPARTNERNUMBERID =e.NUMBERID
WHERE x.ITEMTYPECODE = 'DYR' AND x.TEMPLATECODE = 'OPN' AND (a1.VALUESTRING = '3' OR a3.VALUESTRING = '3') AND x.TRANSACTIONDATE BETWEEN '$Awal' AND '$Akhir'
GROUP BY x.TRANSACTIONNUMBER, a1.VALUESTRING, a2.VALUESTRING, a3.VALUESTRING, a4.VALUESTRING,  x.TRANSACTIONDATE, e.LEGALNAME1,
bc.WHSLOCATIONWAREHOUSEZONECODE,bc.WAREHOUSELOCATIONCODE, f.SUMMARIZEDDESCRIPTION, x.LOTCODE,x.ITEMTYPECODE, x.DECOSUBCODE01, x.DECOSUBCODE02, x.DECOSUBCODE03, x.DECOSUBCODE04,
x.DECOSUBCODE05, x.DECOSUBCODE06, x.DECOSUBCODE07, x.DECOSUBCODE08 ";
