...
$cektgl=sqlsrv_query_safe($con,"SELECT CONVERT(char(10),GETDATE(),120) as tgl,COUNT(tgl_tutup) as ck ,DATEPART(hour,GETDATE()) as jam,CONVERT(char(5),GETDATE(),108) as jam1 FROM dbnow_gdb.tblopname_11 WHERE tgl_tutup='".sqlsrv_escape_str($Awal)."'");
...
b.WHSLOCATIONWAREHOUSEZONECODE IN ('GB0','GB1','GB2','GB5','GB6','GP1','GR2','GR3','GY1','GW2','GW6','PRT','L1','GR6','GDB','LT','PLG','GBK','PLW','PLT','BHS','BSH','KNA')
GROUP BY 
c.SUPPLIERCODE,
c.LOTCREATIONORDERNUMBER,
e.LEGALNAME1, 
...
b.WAREHOUSELOCATIONCODE ";
	...
	$simpan=sqlsrv_query_safe($con,"INSERT INTO dbnow_gdb.tblopname_11
