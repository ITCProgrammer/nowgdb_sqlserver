	    ...
	    <div class="card card-pink">
          ...
          <table id="example4" class="table table-sm table-bordered table-striped" style="font-size:13px;">
				  ...
				  <?php
					...
					if ($sql === false) {
	  				...
	  				while($sql !== false && ($rowd=sqlsrv_fetch_array($sql, SQLSRV_FETCH_ASSOC))){
						...
						if ($tglUpload instanceof DateTime) {
							$tglUpload = $tglUpload->format('Y-m-d H:i:s');
						}
						$tglClosed = $rowd['tgl_closed'];
						if ($tglClosed instanceof DateTime) {
							$tglClosed = $tglClosed->format('Y-m-d H:i:s');
						}
                    ...
                    <td style="text-align: center"><?php echo $tglUpload;?></td>
                    ...
                    <td style="text-align: center"><?php echo $tglClosed;?></td>
