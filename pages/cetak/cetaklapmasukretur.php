...
WHERE x.ITEMTYPECODE = 'GYR' AND x.TEMPLATECODE = 'OPN' AND a1.VALUESTRING = '2' AND x.TRANSACTIONDATE BETWEEN '$_GET[tgl1]' AND '$_GET[tgl2]'
...
WHERE s.TRANSACTIONNUMBER ='$r[TRANSACTIONNUMBER]' 
