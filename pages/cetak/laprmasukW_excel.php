...
header("Content-Disposition: attachment; filename=benang_retur_masukW" . date($_GET['awal']) . ".xls"); //ganti nama sesuai keperluan
...
WHERE INTERNALDOCUMENTLINE.EXTERNALREFERENCE='RETUR' AND STOCKTRANSACTION.LOGICALWAREHOUSECODE ='M011' AND INTERNALDOCUMENTLINE.ITEMTYPEAFICODE='DYR' AND
...
FULLITEMKEYDECODER.SUMMARIZEDDESCRIPTION";
  ...
  while ($rowdb21 = db2_fetch_assoc($stmt1)) {
    ...
    <td class='normal333'>" . $rowdb21['SUBCODE08'] . "</td>
