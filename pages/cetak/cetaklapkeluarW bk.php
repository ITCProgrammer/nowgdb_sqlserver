...
WHERE 
x.CONDITIONRETRIEVINGDATE BETWEEN '$_GET[tgl1]' AND '$_GET[tgl2]' AND 
x.ITEMTYPEAFICODE ='DYR' AND
s.LOGICALWAREHOUSECODE='P504' AND 
NOT x.EXTERNALREFERENCE='RETUR' AND 
...
TRANSACTIONDATE ='".$rowdb21['TRANSACTIONDATE']."' ";
  ...
  if($rowdb21['SUPPLIER']!=""){ $spp=$rowdb21['SUPPLIER'];}else{ $spp="YND-ITTI";}		
  ...
  echo"<tr>
	...
	<td >".$rowdb22['WHSLOCATIONWAREHOUSEZONECODE']."-".$rowdb22['WAREHOUSELOCATIONCODE']."</td>
    </tr>";	
	if($stn=='DUS')
