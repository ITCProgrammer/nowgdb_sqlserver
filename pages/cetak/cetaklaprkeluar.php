...
<table width="100%" border="0" style="width:9.50in;" >
    <thead>
	    <tr>
		 <td><table width="100%" border="0" class="table-list1">
            ...
            <td><div align="center">
              <font size="+1"><strong>LAPORAN HARIAN RETUR KELUAR BENANG</strong></font><br>FW-19-GDB-13 / 02
            </div></td>
           </tr>
          </table></td>
    </tr>
	...
	border-right:0px #000 solid;">TGL: <?php echo date('d F Y', strtotime($Awal)); ?> s/d <?php echo date('d F Y', strtotime($Akhir)); ?></td>
        </tr>
        <tr>
...
GROUP BY
  ...
  echo"<tr>
    ...
    <td>$bon</td>
    <td>$knitt</td>
    <td>$rowdb21[INTERNALREFERENCE]</td>
    <td>$kdbenang</td>
    <td>$rowdb21[SUPP]</td>
