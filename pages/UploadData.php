      ...
      <div class="container-fluid">
		...
		<div class="card card-purple">
          <div class="card-header">
            <h3 class="card-title">Upload Data Persediaan Benang</h3>
...
if (isset($_POST['submit']))
{
    ...
    if (!empty($_FILES['file']['name']) && in_array($_FILES['file']['type'], $fileMimes))
    {
            ...
            while (($getData = fgetcsv($csvFile, 100000, ",")) !== FALSE)
            {
                ...
                sqlsrv_query(
					$con,
					"INSERT INTO dbnow_gdb.tbl_stokfull (tgl_buat, SN, KG, zone, lokasi, project, lot, id_upload) 
					 VALUES ('$tgl_buat', '$SN', '$KG', '$zone', '$lokasi', '$project', '$lot', '$idUp')"
				); 
               
            }
 			
		  $sqlupdateUP=sqlsrv_query(
			  $con, 
			  "UPDATE dbnow_gdb.tbl_upload SET 
			   nama_file='$nameFile',
			   tgl_upload=GETDATE()
			   WHERE id='$idUp'"
		  );
