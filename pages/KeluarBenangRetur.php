      ...
      <div class="container-fluid">
		...
		<div class="card card-default">
          <div class="card-header">
            <h3 class="card-title">Filter Data Tgl Retur Ke Supplier Benang</h3>
		...
		<div class="card card-danger">
              <div class="card-header">
                <h3 class="card-title">Detail Data Retur Ke Supplier Benang</h3>
				<a href="pages/cetak/cetaklaprkeluar.php?tgl1=<?php echo $Awal; ?>&tgl2=<?php echo $Akhir; ?>" class="btn btn-sm btn-success float-right" target="_blank"><i class="fa fa-file"></i> to Print</a>  
          </div>
              <!-- /.card-header -->
              <div class="card-body">
...
STOCKTRANSACTION.LOGICALWAREHOUSECODE = 'M011'
	AND
INTERNALDOCUMENT.EXTERNALREFERENCEDATE BETWEEN '$Awal' AND '$Akhir'
...
GROUP BY
    ...
    while($rowdb21 = db2_fetch_assoc($stmt1)){ 
      ...
      <td style="text-align: center"><?php echo $rowdb21['INTERNALREFERENCE']; ?></td>
