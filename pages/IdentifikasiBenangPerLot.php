    ...
    <div class="card">
      ...
      <div class="card-body">
        <table id="example1" class="table table-sm table-bordered table-striped"
          ...
          <thead>
            <tr>
              <th colspan="12" valign="middle" style="text-align: center">Masuk</th>
          ...
          <tbody>
            ...
            $sqlDB21 = "SELECT 
			  MRNHEADER.MRNDATE,MRNHEADER.CHALLANNO,MRNHEADER.PURCHASEORDERCODE,
    		  ...
    		  FULLITEMKEYDECODER.SUMMARIZEDDESCRIPTION,a2.VALUESTRING AS CODEWARNA
FROM MRNHEADER MRNHEADER
INNER JOIN MRNDETAIL MRNDETAIL ON MRNHEADER.CODE = MRNDETAIL.MRNHEADERCODE
LEFT JOIN ADSTORAGE a2 ON a2.UNIQUEID = MRNHEADER.ABSUNIQUEID AND a2.NAMENAME = 'WARNA'
LEFT OUTER JOIN STOCKTRANSACTION STOCKTRANSACTION ON STOCKTRANSACTION.TRANSACTIONNUMBER = MRNDETAIL.TRANSACTIONNUMBER
...
WHERE (MRNHEADER.MRNPREFIXCODE = 'YRL' OR MRNHEADER.MRNPREFIXCODE = 'YRI') AND STOCKTRANSACTION.LOTCODE='$LOT'
GROUP BY MRNHEADER.MRNDATE,MRNHEADER.CHALLANNO,MRNHEADER.PURCHASEORDERCODE,MRNDETAIL.ORDERLINE,
              ...
              STOCKTRANSACTION.TRANSACTIONNUMBER,
              BUSINESSPARTNER.LEGALNAME1,
    		 FULLITEMKEYDECODER.SUMMARIZEDDESCRIPTION,a2.VALUESTRING ";
       ...
       PRODUCT.SUBCODE07='" . trim($rowdb21['DECOSUBCODE07']) . "' ";
              ...
              <tr>
                ...
                <td style="text-align: center">
                  <?php echo $rowdb21['MRNDATE']; ?>
                </td>
                <td style="text-align: center">
                  <?php echo $rowdb21['PURCHASEORDERCODE'] . "-" . $rowdb21['ORDERLINE']; ?>
                </td>
                <td style="text-align: center">
                  <?php echo $rowdb21['CHALLANNO']; ?>
                </td>
                ...
                <td style="text-align: left">
                  <?php echo $rowdb23['LONGDESCRIPTION'] . $rowdb23['SHORTDESCRIPTION']; ?>
                </td>
                <td style=" text-align: center">
                ...
                <td style="text-align: right">
                  <?php echo $rowdb21['COBA_JUMLAH']; ?>
                </td>
                <td style="text-align: right">
                  <?php echo $rowdb21['COBA_TOTAL']; ?>
                </td>
                <td style="text-align: right"><?php echo $rowdb21['WHSLOCATIONWAREHOUSEZONECODE']."-".$rowdb21['WAREHOUSELOCATIONCODE']; ?></td>
                <td style=" text-align: right">
                  <?php if ($rowdb22['ROL'] != "") {
                    echo $rowdb22['ROL'];
                  } else {
                ...
                <td><a href="#" class="btn
                btn-success btn-xs">Lihat Detail</a></td>
              </tr>
              <?php
              $no++;
            } ?>
