...
STOCKTRANSACTION.TOKENCODE,
ADSTORAGE.VALUESTRING AS SUPPLIER,
...
LEFT OUTER JOIN DB2ADMIN.ADSTORAGE ADSTORAGE ON ADSTORAGE.UNIQUEID =INTERNALDOCUMENTLINE.ABSUNIQUEID AND ADSTORAGE.NAMENAME ='SuppName' 
WHERE NOT INTERNALDOCUMENTLINE.EXTERNALREFERENCE='RETUR' AND 
STOCKTRANSACTION.TRANSACTIONDATE BETWEEN '$Awal' AND '$Akhir' AND NOT INTERNALDOCUMENTLINE.ORDERLINE IS NULL AND 
STOCKTRANSACTION.TOKENCODE='RECEIVED' AND (STOCKTRANSACTION.ITEMTYPECODE ='GYR' OR STOCKTRANSACTION.ITEMTYPECODE ='DYR') 
GROUP BY
STOCKTRANSACTION.LOTCODE,
STOCKTRANSACTION.TOKENCODE,
INTERNALDOCUMENTLINE.INTDOCUMENTPROVISIONALCODE,
...
TRANSACTIONDATE ='".$rowdb21['TRANSACTIONDATE']."' ";
	...
	$rowdb22 = db2_fetch_assoc($stmt2);	
      ...
      <td style="text-align: left"><?php echo $rowdb21['SUPPLIER'] ?></td>
      ...
      <td><?php echo $rowdb22['WHSLOCATIONWAREHOUSEZONECODE']."-".$rowdb22['WAREHOUSELOCATIONCODE']; ?></td>
    </tr>				  
	<?php 
	 $no++; } ?>
				  </tbody>
