...
$total_qty = null;		
  ...
  $sqlDB21 = "SELECT MRNHEADER.MRNDATE,MRNHEADER.CHALLANNO,MRNHEADER.PURCHASEORDERCODE,
              ...
              SUM(BASEPRIMARYQUANTITY) AS QTY_KG,
              SUM(BASESECONDARYQUANTITY) AS QTY_CONES,
			  COUNT(BASEPRIMARYQUANTITY) AS QTY_DUS,
              ...
              WHERE MRNHEADER.MRNDATE BETWEEN '$Awal' AND '$Akhir' AND MRNHEADER.MRNPREFIXCODE = 'YRL'
              GROUP BY MRNHEADER.MRNDATE,MRNHEADER.CHALLANNO,MRNHEADER.PURCHASEORDERCODE,
              MRNHEADER.MRNPREFIXCODE,MRNHEADER.PURCHASEORDERCOUNTERCODE,
              STOCKTRANSACTION.DECOSUBCODE01,STOCKTRANSACTION.DECOSUBCODE02,
              STOCKTRANSACTION.DECOSUBCODE03,STOCKTRANSACTION.DECOSUBCODE04,
              STOCKTRANSACTION.DECOSUBCODE05,STOCKTRANSACTION.DECOSUBCODE06,
  ...
  $cd = trim($rowdb21['DECOSUBCODE01'])."-".trim($rowdb21['DECOSUBCODE02'])."-"
    ...
    if ($rowdb21['DESTINATIONWAREHOUSECODE'] =='M501') { $knitt = 'KNITTING ITTI- BENANG'; }
