...
$no=1;   
$c=0;				  
$sql = mysqli_query($con," SELECT tgl_tutup,tipe,sum(qty) as qty,sum(cones) as cones,sum(weight) as kg,DATE_FORMAT(now(),'%Y-%m-%d') as tgl FROM tblopname GROUP BY tgl_tutup,tipe ORDER BY tgl_tutup DESC LIMIT 30");		  
